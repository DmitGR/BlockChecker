namespace BlockChecker
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.sessionCheck = new System.Windows.Forms.Button();
			...
			// sessionPage
			// 
			this.sessionPage.Controls.Add(this.sessionCheck);
			this.sessionPage.Controls.Add(this.groupBox5);
			...
			this.sessionLabel.Location = new System.Drawing.Point(6, 43);
			this.sessionLabel.Name = "sessionLabel";
			this.sessionLabel.Size = new System.Drawing.Size(46, 16);
			this.sessionLabel.TabIndex = 1;
			this.sessionLabel.Text = "label5";
			// 
			// groupBox5
			// 
			this.groupBox5.Controls.Add(this.sessionLabel);
			this.groupBox5.Location = new System.Drawing.Point(640, 6);
			this.groupBox5.Name = "groupBox5";
			this.groupBox5.Size = new System.Drawing.Size(296, 97);
			this.groupBox5.TabIndex = 2;
			this.groupBox5.TabStop = false;
			this.groupBox5.Text = "Текущая сессия";
			// 
			// sessionCheck
			// 
			this.sessionCheck.Location = new System.Drawing.Point(7, 31);
			this.sessionCheck.Name = "sessionCheck";
			this.sessionCheck.Size = new System.Drawing.Size(204, 52);
			this.sessionCheck.TabIndex = 3;
			this.sessionCheck.Text = "Выбрать сессию";
			this.sessionCheck.UseVisualStyleBackColor = true;
			this.sessionCheck.Click += new System.EventHandler(this.sessionCheck_Click);
			// 
			// MainForm
			// 
		...
		private System.Windows.Forms.Button sessionCheck;
